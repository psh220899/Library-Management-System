...
public class returnbook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGap(79, 79, 79)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jTextField11, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 189, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jTextField12, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 189, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(409, 409, 409))
        );
        ...
        jButton3.getAccessibleContext().setAccessibleName("Return");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try
        {
            String sql="insert into returntable (bookid,stud_id,issueDate,returnDate) values(?,?,?,?)";
            String sql1="select * from issuetable";
            String s1=null,s2=null,s3=null;
            Date date=new Date();
            SimpleDateFormat sd=new SimpleDateFormat("yyyy-mm-dd");
           // String s4 = sd.format(date)+"";
            ...
            if(rs1.next())
            {
                ...
                jTextField12.setText(sd.format(date));
            ...
            pst.setString(2, s2); 
            pst.setString(3,s3);
            pst.setString(4, sd.format(date));
            pst.execute();
    ...
    void delete()
    {
        String sql="delete from issuetable where stud_id=?";
        try{
            pst=conn.prepareStatement(sql);
